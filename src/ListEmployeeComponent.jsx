...
class ListEmployeeComponent extends Component {
   ...
   render() {
        return (
           <div>
                <h2 className="text-center">Atualizar Clientes</h2>
                <div className = "row">
                  <div>
                     <button className="btn btn-primary" onClick={this.addEmployee}> Adicionar Clientes</button>
                  </div>
                                    ...
                                    <tr key = {employee.id}>
                                       ...
                                       <td>
                                          <button onClick={ () => this.editEmployee(employee.id)} className="btn btn-info">Atualizar </button>
                                           ...
                                           <button style={{marginLeft: "10px"}} onClick={ () => this.viewEmployee(employee.id)} className="btn btn-info">Lista </button>
                                       </td>
                                    </tr>
                                )
                            }
